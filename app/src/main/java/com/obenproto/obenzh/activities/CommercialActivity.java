...
import com.obenproto.obenzh.adapters.CommercialListViewAdapter;
...
public class CommercialActivity extends Activity {
    ...
    public void showAlert() {
        ...
        builder.setTitle("保存并退出");
        builder.setMessage("您所有的录音都已经保存。您可以随时返回并继续录音。");
        builder.setCancelable(true);
        builder.setPositiveButton("保存并退出",
        ...
        builder.setNegativeButton("继续录音",
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
    ...
    public void onGetPhrases() {
        ...
        ObenAPIService client = ObenAPIClient.newInstance(ObenAPIService.class);
        Call<List<ObenApiResponse>> call = client.getPhraseData(chinese_level);
